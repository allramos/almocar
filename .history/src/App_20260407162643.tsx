    ...
    >
      ...
      >
        ...
        <div className="text-ink-dim text-[13px] leading-relaxed space-y-4 font-sans">
          <p>
            <span className="text-ink font-medium">ALMOÇAR</span> é um
            acrônimo:
          </p>
          <div className="flex flex-col gap-0.5 pl-1">
            <div><span className="text-ember">A</span>mbiente</div>
            <div><span className="text-ember">L</span>údico</div>
            <div><span className="text-ember">d</span>e</div>
            <div><span className="text-ember">M</span>onitoramento</div>
            <div><span className="text-ember">d</span>e</div>
            <div><span className="text-ember">O</span>perações</div>
            <div><span className="text-ember">e</span></div>
