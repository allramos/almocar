      ...
      >
        ...
        <div className="text-ink-dim text-[13px] leading-relaxed space-y-4 font-sans">
          <p>
            ...
            para <span className="text-ink">Ambiente</span>{" "}
            <span className="text-ink">Lúdico de</span>{" "}
            <span className="text-ink">Monitoramento de</span>{" "}
            <span className="text-ink">Operações e</span>{" "}
